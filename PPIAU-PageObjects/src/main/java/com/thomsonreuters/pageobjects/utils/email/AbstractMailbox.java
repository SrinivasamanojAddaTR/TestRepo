...
/**
 * Created by Pavel_Ardenka on 04/01/2017.
 */
public abstract class AbstractMailbox implements Mailbox {
    ...
    void initConnectionAndOpenFolder(String folderName, int accessMode) throws MessagingException {
        ...
        if (openedFolder == null || !openedFolder.isOpen() || !(openedFolder.getName().equalsIgnoreCase(folderName) && openedFolder.getMode() == accessMode)) {
    ...
    public String toString() {
        return this.getClass().getName() + "{" +
                ...
                ", store connected='" + (store != null && store.isConnected()) + '\'' +
                ", folder opened='" + (openedFolder != null && openedFolder.isOpen()) + '\'' +
                '}';
    }
}

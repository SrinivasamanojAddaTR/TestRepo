...
public class ClientIdTest1 extends BaseStepDef {
	
    private WLNHeader wlnHeader = new WLNHeader();
	private AbilityToChangeClientIDAfterLogin1 abilityToChangeClientIDAfterLogin = new AbilityToChangeClientIDAfterLogin1();

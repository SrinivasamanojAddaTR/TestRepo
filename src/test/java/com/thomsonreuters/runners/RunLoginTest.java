...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-htmlreport/ANZLoginReport", "junit:target/junit_cucumber.xml", "json:target/json-files/RunLoginTest.json", "com.epam.reportportal.cucumber.ScenarioReporter"},

...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-htmlreport/ANZFoldersReport", "junit:target/junit_cucumber.xml", "json:target/json-files/RunFoldersTest.json"},
        features = "src/test/resources/com/thomsonreuters/features/folders",
        tags = {"~@wip", "~@manual"},
        glue = {"com.thomsonreuters.step_definitions"},
        monochrome = true,
        snippets = SnippetType.CAMELCASE)
public class RunFoldersTest {

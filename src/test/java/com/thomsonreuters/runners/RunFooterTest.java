...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-htmlreport/ANZFooterReport", "junit:target/junit_cucumber.xml", "json:target/json-files/RunFooterTest.json", "com.epam.reportportal.cucumber.ScenarioReporter"},
...
public class RunFooterTest extends BaseCucumberTestRunner {

    private static final Logger LOG = LoggerFactory.getLogger(RunFooterTest.class);

...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-htmlreport/ANZDeliveryReport", "junit:target/junit_cucumber.xml", "json:target/json-files/RunDeliveryTest.json", "com.epam.reportportal.cucumber.ScenarioReporter"},

...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-htmlreport/ANZFavouriteReport", "junit:target/junit_cucumber.xml", "json:target/json-files/RunFavouriteTest.json", "com.epam.reportportal.cucumber.ScenarioReporter"},

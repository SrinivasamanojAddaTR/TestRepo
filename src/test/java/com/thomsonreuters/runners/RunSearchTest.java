...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-htmlreport/ANZSearchReport", "junit:target/junit_cucumber.xml", "json:target/json-files/RunSearchTest.json", "com.epam.reportportal.cucumber.ScenarioReporter"},

...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-htmlreport/ANZDocumentReport", "junit:target/junit_cucumber.xml", "json:target/json-files/RunDocumentTest.json", "com.epam.reportportal.cucumber.ScenarioReporter"},

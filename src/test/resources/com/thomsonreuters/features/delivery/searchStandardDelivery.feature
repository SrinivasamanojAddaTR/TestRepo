...
Scenario Outline: [818824] Download documents in PDF format
    ...
    And the user edits the basic download options as follows 
		...
		| Only pages with terms | Not selected |
	Then user downloads the document with name "Practical Law - 2 full text items for <query>" and extension ".pdf" 
...
Scenario Outline: [818824] Download documents in zip file
    ...
    And the user edits the basic download options as follows 
		...
		| Only pages with terms | Not selected |
	Then user downloads the document with name "Practical Law - 2 full text items for <query>" and extension "zip" 
	Examples: 
		| 	query 	| 
		|	test | 

...
public class RecentConvictionsWidget extends LegalUpdatesWidgetPage {
	...
	public List<WebElement> getAllProsecutingAuthorities(String widgetName) {
		return retryingFindElements(By.xpath(String.format("//div[@id='coid_website_browseRightColumn']//h3[text()='%s']/following-sibling::div[@class='co_genericBoxContent']//div[@class='co_artifactContent']//h4//span[@class='co_resource_name']", widgetName)));
	}

...
@CucumberOptions(
        plugin = {"pretty", "junit:target/junit_cucumber.xml", "json:target/json-files/ReRunAnnotationsAtTheTopFontSizePart2.json", "com.epam.reportportal.cucumber.ScenarioReporter"},
        features = "@target/ReRunAnnotationsAtTheTopFontSizePart2.txt",
        glue = {"com.thomsonreuters.step_definitions", "com.thomsonreuters.hooks"},
        monochrome = true,
        snippets = SnippetType.CAMELCASE)
public class ReRunAnnotationsAtTheTopFontSizePart2 {
    private static final Logger LOG = LoggerFactory.getLogger(ReRunAnnotationsAtTheTopFontSizePart2.class);

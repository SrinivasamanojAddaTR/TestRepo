...
@CucumberOptions(
        plugin = {"pretty", "junit:target/junit_cucumber.xml", "json:target/json-files/ReRunDeliveryPart5.json", "com.epam.reportportal.cucumber.ScenarioReporter"},
        features = "@target/ReRunDeliveryPart5.txt",
        glue = {"com.thomsonreuters.step_definitions", "com.thomsonreuters.hooks"},
        monochrome = true,
        snippets = SnippetType.CAMELCASE)
public class ReRunDeliveryPart5 extends BaseCucumberTestRunner {

    private static final Logger LOG = LoggerFactory.getLogger(ReRunDeliveryPart5.class);

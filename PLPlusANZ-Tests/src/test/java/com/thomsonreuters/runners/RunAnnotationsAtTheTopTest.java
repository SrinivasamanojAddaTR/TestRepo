...
@CucumberOptions(
        plugin = {"pretty", "junit:target/junit_cucumber.xml", "json:target/json-files/RunAnnotationsAtTheTopTest.json", "com.epam.reportportal.cucumber.ScenarioReporter","rerun:target/ReRunAnnotationsAtTheTop.txt"},

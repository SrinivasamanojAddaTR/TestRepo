...
@CucumberOptions(
        plugin = {"pretty", "junit:target/junit_cucumber.xml", "json:target/json-files/ReRunDeliveryPart3.json", "com.epam.reportportal.cucumber.ScenarioReporter"},
        features = "@target/ReRunDeliveryPart3.txt",
        glue = {"com.thomsonreuters.step_definitions", "com.thomsonreuters.hooks"},
        monochrome = true,
        snippets = SnippetType.CAMELCASE)
public class ReRunDeliveryPart3 extends BaseCucumberTestRunner {

    private static final Logger LOG = LoggerFactory.getLogger(ReRunDeliveryPart3.class);

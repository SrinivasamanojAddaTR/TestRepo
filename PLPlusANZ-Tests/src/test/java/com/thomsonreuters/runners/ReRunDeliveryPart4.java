...
@CucumberOptions(
        plugin = {"pretty", "junit:target/junit_cucumber.xml", "json:target/json-files/ReRunDeliveryPart4.json", "com.epam.reportportal.cucumber.ScenarioReporter"},
        features = "@target/ReRunDeliveryPart4.txt",
        glue = {"com.thomsonreuters.step_definitions", "com.thomsonreuters.hooks"},
        monochrome = true,
        snippets = SnippetType.CAMELCASE)
public class ReRunDeliveryPart4 extends BaseCucumberTestRunner {

    private static final Logger LOG = LoggerFactory.getLogger(ReRunDeliveryPart4.class);

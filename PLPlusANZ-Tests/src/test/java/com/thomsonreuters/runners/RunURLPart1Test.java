...
@CucumberOptions(
        plugin = {"pretty", "junit:target/junit_cucumber.xml", "json:target/json-files/RunURLPart1Test.json", "com.epam.reportportal.cucumber.ScenarioReporter","rerun:target/ReRunURLPart1.txt"},
        features = "classpath:com/thomsonreuters/features/urls/part1",
        tags = {"~ ", "~@manual"},
        glue = {"com.thomsonreuters.step_definitions", "com.thomsonreuters.hooks"},
        monochrome = true,
        snippets = SnippetType.CAMELCASE)
public class RunURLPart1Test extends BaseCucumberTestRunner {

    private static final Logger LOG = LoggerFactory.getLogger(RunURLPart1Test.class);

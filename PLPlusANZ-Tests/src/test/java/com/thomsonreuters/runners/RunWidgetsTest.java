...
@CucumberOptions(
        plugin = {"pretty", "junit:target/junit_cucumber.xml", "json:target/json-files/RunWidgetsTest.json", "com.epam.reportportal.cucumber.ScenarioReporter"},
        features = "classpath:com/thomsonreuters/features/widgets",
        tags = {"~ ", "~@manual"},
        glue = {"com.thomsonreuters.step_definitions", "com.thomsonreuters.hooks"},
        monochrome = true,
        snippets = SnippetType.CAMELCASE)
public class RunWidgetsTest extends BaseCucumberTestRunner {

...
@CucumberOptions(
        plugin = {"pretty", "junit:target/junit_cucumber.xml", "json:target/json-files/RunBreadCrumbPart1Test.json", "com.epam.reportportal.cucumber.ScenarioReporter","rerun:target/ReRunBreadCrumbPart1.txt"},

...
public class MeetTheTeamTestSteps extends BaseStepDef {
    ...
    @Then("^there are team members listed for practice area$")
    public void practiceAreaListContainsNumberOfProfiles() throws Throwable {
        assertThat(meetTheTeam.contributorProfiles().size()).as("Number of profiles is not correct").isGreaterThan(ZER0);
    }
    ...
    @Then("^there are team members listed$")
    public void userShouldSeeProfiles() throws Throwable {
        assertThat(meetTheTeam.contributorProfiles().size()).as("Number of profiles is not correct on main page").isGreaterThan(ZER0);
    }

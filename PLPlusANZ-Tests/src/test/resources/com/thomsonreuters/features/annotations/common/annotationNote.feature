...
@archived
  ...
  Scenario: Checking that user can copy with reference
    ...
    And the user has accessed annotations text box
    And user copies text from clipboard to annotation text box
    Then user checks that text was copied with reference and equals "This note examines age discrimination in employment under the Age Discrimination Act 2004 (Cth) (ADA 2004). It covers direct and indirect age discrimination, vicarious liability of an employer in an age discrimination claim, victimisation of an employee in an age discrimination claim, and the exemptions under the ADA 2004 when discrimination will not be unlawful. Overview of federal age discrimination, Practical Law ANZ Practice Note w-001-4954"
...
## Download	
###############################################################################################################
  Scenario Outline: [831297] Download documents in PDF format-<id>
    ...
    Examples:
      | guid1                             | guid2                             | docText1                      | docText2               | id |
      | If13ba3b4d4d811e598dc8b09b4f043e0 | Ifb5c26cc995811e598dc8b09b4f043e0 | When are shares transferable? | What is due diligence? | 1  |


  Scenario Outline: [831297] Download documents in zip file-<id>
    Given ANZ user navigates directly to document with guid "<guid1>"
    And ANZ user navigates directly to document with guid "<guid2>"
    When the user clicks on 'History' link on the header
    And the user clicks on 'Documents' tab on the History page
    ...
    Examples:
      | guid1                             | guid2                             | id |
      | If13ba3b4d4d811e598dc8b09b4f043e0 | Ifb5c26cc995811e598dc8b09b4f043e0 | 1  |


  Scenario Outline: [831297] Download list of items in PDF format-<id>
    Given ANZ user navigates directly to document with guid "<guid1>"
    And ANZ user navigates directly to document with guid "<guid2>"
    When the user clicks on 'History' link on the header
    And the user clicks on 'Documents' tab on the History page
  ...
  Scenario Outline: [831297] Download document in RTF format-<id>
    Given ANZ user navigates directly to document with guid "<guid>"
    When the user clicks on 'History' link on the header
    And the user clicks on 'Documents' tab on the History page
    And the user selects the checkbox associated with document "1"
    ...
    Examples:
      | guid                              | name               | id |
      | If13ba3b4d4d811e598dc8b09b4f043e0 | Transfer of shares | 1  |


  Scenario Outline: [831297] Download document in Microsoft Word format-<id>
    Given ANZ user navigates directly to document with guid "<guid>"
    When the user clicks on 'History' link on the header
    And the user clicks on 'Documents' tab on the History page
    And the user selects the checkbox associated with document "1"
  ...
  Scenario Outline: [831297] Download document with table of contents in PDF format-<id>
    Given ANZ user navigates directly to document with guid "<guid>"
    When the user clicks on 'History' link on the header
    And the user clicks on 'Documents' tab on the History page
    And the user selects the checkbox associated with document "1"
    ...
    Examples:
      ...
      | If13ba3b4d4d811e598dc8b09b4f043e0 | Transfer of shares | As a general rule | Steps for transferring shares | 1  |


  Scenario Outline: [831297] Download document without table of contents in PDF format-<id>
    Given ANZ user navigates directly to document with guid "<guid>"
    When the user clicks on 'History' link on the header
    And the user clicks on 'Documents' tab on the History page
    And the user selects the checkbox associated with document "1"
...
## Email	
###############################################################################################################
  Scenario Outline: [831297] Email document in Microsoft Word format-<id>
    Given ANZ user navigates directly to document with guid "<guid>"
    When the user clicks on 'History' link on the header
    And the user clicks on 'Documents' tab on the History page
    And the user selects the checkbox associated with document "1"
    ...
    Examples:
      ...
      | If13ba3b4d4d811e598dc8b09b4f043e0 | Transfer of shares | tr-anz-tester3@epam-email-pluk.thomsonreuters.com | 1  |

  Scenario Outline: [831297][847182] Email resource link only-<id>
    Given ANZ user navigates directly to document with guid "<guid>"
    When the user clicks on 'History' link on the header
    And the user clicks on 'Documents' tab on the History page
    And the user selects the checkbox associated with document "1"
    ...
    Examples:
      | guid                              | title              | mailbox                                           | id |
      | If13ba3b4d4d811e598dc8b09b4f043e0 | Transfer of shares | tr-anz-tester1@epam-email-pluk.thomsonreuters.com | 1  |

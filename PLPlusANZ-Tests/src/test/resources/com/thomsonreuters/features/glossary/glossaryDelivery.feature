...
#848623 Bug [PLAU only] Glossary: Error when opening glossary article (Stream not readable)
  ...
  Scenario Outline: Email glossary term - MS Word format-<id>
    ...
    Examples:
      | term       | mailbox                                            | id |
      | Disability | tr-anz-tester2@epam-email-pluk.thomsonreuters.com  | 1  |

  Scenario Outline: Email glossary term - RTF format-<id>
    Given the user clicks on glossary term "<term>"
    When clicks on email delivery option for the document
    Then the user should be able to see Email basic tab options as follows
      | Subject | <term> |
  ...
  Scenario Outline: Email glossary term - PDF format-<id>
    Given the user clicks on glossary term "<term>"
    When clicks on email delivery option for the document
    Then the user should be able to see Email basic tab options as follows
      | Subject | <term> |
    ...
    Examples:
      | term       | docText                          | mailbox                                           | id |
      | Disability | A disability may currently exist | tr-anz-tester2@epam-email-pluk.thomsonreuters.com | 1  |

  Scenario Outline: [847182] Email glossary term - Resource Link Only format-<id>
    Given the user clicks on glossary term "<term>"
    When clicks on email delivery option for the document
    Then the user should be able to see Email basic tab options as follows
      | Subject | <term> |
    ...
    Examples:
      | term       | guid                              | mailbox                                            | id |
      | Disability | Ice50947ba27811e598dc8b09b4f043e0 | tr-anz-tester2@epam-email-pluk.thomsonreuters.com  | 1  |
...
###########################################################################################################################################
  ...
  Scenario Outline: Download glossary term - MS Word format-<id>
    Given the user clicks on glossary term "<term>"
  ...
  Scenario Outline: Download glossary term - RTF format-<id>
    Given the user clicks on glossary term "<term>"
    When clicks on Download delivery option for the document
    And the user edits the basic download options as follows
      | Format | Word Processor (RTF) |
  ...
  Scenario Outline: Download glossary term - PDF format-<id>
    Given the user clicks on glossary term "<term>"
    When clicks on Download delivery option for the document
    And the user edits the basic download options as follows
      | Format | PDF |
    ...
    Examples:
      | term       | docText                          | id |
      | Disability | A disability may currently exist | 1  |
...
###########################################################################################################################################
  ...
  Scenario Outline: Print glossary term-<id>
    Given the user clicks on glossary term "<term>"
